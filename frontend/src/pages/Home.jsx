...
const HomePage = () => {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            if (issueCount < 1250)
                setIssueCount((prev) => Math.min(prev + 15, 1250));
            if (resolvedCount < 1048)
                setResolvedCount((prev) => Math.min(prev + 12, 1048));
            if (userCount < 3500)
                setUserCount((prev) => Math.min(prev + 40, 3500));
        }, 30);
    ...
    const handleDashboardClick = () => {
        ...
        if (user.role === "citizen") {
            ...
            if (user.category === "MunicipalCorporation") {
                navigate("/municipal-dashboard");
            } else if (user.category === "AreaCounsellor") {
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            From infrastructure problems to public safety
                            concerns, we connect you with the right authorities.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {activeTab === "public"
                            ? categories.map((category, index) => (
                                  <div
                                      key={index}
                                      className="bg-white rounded-xl border border-gray-100 p-6 text-center shadow-sm hover:shadow-md hover:border-blue-100 transition cursor-pointer"
                                  >
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4">
                            How PeopleVoice Works
                        </h2>
                        <p className="text-xl max-w-3xl mx-auto text-blue-100">
                            A simple, transparent process designed to get
                            results.
                        </p>
                    </div>
                        ...
                        {processSteps.map((step, index) => (
                            <div key={index} className="relative">
                                ...
                                {index < processSteps.length - 1 && (
                                    <div
                                        className="hidden lg:block absolute top-1/4 left-full w-full h-0.5 bg-blue-400 transform -translate-y-1/2 z-0"
                                        style={{ width: "50%" }}
                                    ></div>
                                )}
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        <div className="md:w-1/2">
                            <h2 className="text-3xl font-bold text-gray-900 mb-6">
                                Bridging Citizens and Local Government
                            </h2>
                            <p className="text-lg text-gray-600 mb-6">
                                PeopleVoice creates a direct channel between
                                citizens and authorities, ensuring:
                            </p>
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Area counselors accountable with
                                            clear deadlines and transparent
                                            progress tracking
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Automatic issue escalation to
                                            Municipal Corporation if deadlines
                                            are missed
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Photo verification of both issues
                                            and resolutions for complete
                                            transparency
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="bg-blue-50 rounded-xl p-8 border border-blue-100">
                                ...
                                <div className="space-y-6">
                                    <div className="flex">
                                        ...
                                        <div className="bg-white rounded-lg p-4 shadow-sm flex-1">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Issue is submitted with location
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="bg-white rounded-lg p-4 shadow-sm flex-1">
                                            <h4 className="font-medium text-gray-900 mb-1">
                                                Area Counselor Verification
                                            </h4>
                                            <p className="text-sm text-gray-600">
                                                Issue validated and assigned a
                                                resolution deadline
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="bg-white rounded-lg p-4 shadow-sm flex-1">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Issue resolved with proof or
                                                escalated to Municipal
                                                Corporation
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="bg-white rounded-lg p-4 shadow-sm flex-1">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                Citizens confirm resolution with
                                                feedback
                                            </p>
                                        </div>
                                    </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="md:w-7/12 order-1 md:order-2 mb-8 md:mb-0">
                            ...
                            <p className="text-lg text-gray-600 mb-6">
                                Beyond public infrastructure, we connect you
                                with verified local service providers for your
                                private household needs.
                            </p>
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Every service provider undergoes
                                            background verification and skill
                                            certification
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Rate and review services, with
                                            platform support for dispute
                                            resolution
                                        </p>
                                    </div>
                                </div>
            ...
            <section className="py-16 bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Explore the innovative tools that make PeopleVoice a
                            comprehensive community solution.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="flex flex-col items-center text-center p-6">
                            ...
                            <p className="text-gray-600">
                                Document community issues with photos and
                                location data for faster resolution by local
                                authorities.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center p-6">
                            ...
                            <p className="text-gray-600">
                                Connect with trusted local professionals through
                                our secure verification system.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-col items-center text-center p-6">
                            ...
                            <p className="text-gray-600">
                                Discuss local initiatives and share ideas with
                                neighbors to build stronger communities.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="lg:w-2/5">
                            ...
                            <p className="text-xl text-gray-600 mb-8">
                                Access real-time insights about your
                                neighborhood through our intuitive dashboard.
                            </p>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Track resolved issues and response
                                            times in your area.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Visualize issue hotspots and service
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">
                                            Identify which community issues need
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-gray-400 mb-6">
                                ...
                                transparent, effective community improvement.
                            </p>
                        </div>
