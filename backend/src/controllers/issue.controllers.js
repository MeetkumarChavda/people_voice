    ...
    getIssueById: async (req, res) => {
        try {
            ...
            if (!isValidObjectId(id)) {
                return res
                    .status(400)
                    .json({ error: "Invalid issue ID format" });
            }
        ...
        try {
            ...
            if (!phaseData || typeof phaseData !== "object") {
                return res.status(400).json({
                    error: "phaseData is required and must be an object",
                });
            }
